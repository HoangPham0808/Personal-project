...
const BASE_PATH = 'Personal project/DACN/internal/';
...
const menuRoutes = {
    ...
    'facilities.php': '../layout/manage_facilities/facilities.php',
    'promotion.php': '../layout/manage_promotion/promotion.php',
    'management_invoice.php': '../layout/management_invoice/management_invoice.php',
    'management_support.php': '../layout/management_support/management_support.php',
    'system.php': '../layout/manage_system/system.php',
    'management_statistics.php': '../layout/management_statistics/management_statistics.php',
    'management_schedule.php': '../layout/management_schedule/management_schedule.php',
    'management_package.php': '../layout/management_package/management_package.php',
    'customer.php': '../layout/manage_customer/customer.php',
    'management_staff.php': '../layout/management_staff/management_staff.php',
    'management_branch.php': '../layout/management_branch/management_branch.php'
};
